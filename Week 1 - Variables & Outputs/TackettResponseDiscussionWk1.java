public class TackettResponseDiscussionWk1 {
	public static void main(String[] args) {
		int countries; //create a number for countries visited
		String name; //variable for my name
		countries = 0; //declare number of countries
